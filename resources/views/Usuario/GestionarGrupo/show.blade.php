            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/grupo/' . $grupo->id . '/edit') }}" title="Edit Grupo"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Descripcion </th><td> {{ $grupo->descripcion }} </td></tr><tr><th> Id Institucion </th><td> {{ $grupo->id_institucion }} </td></tr>
                                </tbody>
                            </table>
                        </div>
