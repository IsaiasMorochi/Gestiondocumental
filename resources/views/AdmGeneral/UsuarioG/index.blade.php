        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading"><center> ADMINISTRADORES </center></div>
                    <div class="panel-body">
                        <a href="{{ url('AdmGeneral/UsuarioG/create') }}" class="btn btn-success btn-sm" title="Agregar Nuevo Administrador">
                            <i class="fa fa-plus" aria-hidden="true"></i> Agrega Nuevo Administrador
                        </a>
