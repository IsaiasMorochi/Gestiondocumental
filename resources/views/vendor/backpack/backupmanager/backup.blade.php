...
<!-- Default box -->
  <div class="box">
    <div class="box-body">
      <button id="create-new-backup-button" href="{{ url(config('backpack.base.route_prefix', 'admin').'/backup/create') }}" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Nuevo Backup</span></button>
      <br>
      <h3>Listado de Backups:</h3>
                ...
                success: function(result) {
                    ...
                    else
                    {
                        new PNotify({
                            ...
                            text: "Se ha creado Backup correctamente",
                            type: "success"
                        });
                    }
        ...
        if (confirm("{{ trans('backpack::backup.delete_confirm') }}") == true) {
            $.ajax({
                ...
                success: function(result) {
                    // Show an alert with the result
                    new PNotify({
                        title: "Operacion Completado",
                        text: "Backup ha sido eliminado",
                        type: "success"
                    });
